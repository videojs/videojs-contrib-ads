...
When updating an ad plugin's dependency on videojs-contrib-ads accross [major version](https://semver.org/) updates, refer to these migration guides in order to update your integration.
