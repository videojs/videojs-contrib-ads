...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1____ = __webpack_require__(18);
/*
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_video_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_video_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_video_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_global_window__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_global_document__ = __webpack_require__(3);
...
var State = function () {
  ...
  State.prototype.onContentEnded = function onContentEnded() {
    __WEBPACK_IMPORTED_MODULE_0_video_js___default.a.log.warn('Unexpected contentended event');
  };
  ...
  State.prototype.startLinearAdMode = function startLinearAdMode() {
    __WEBPACK_IMPORTED_MODULE_0_video_js___default.a.log.warn('Unexpected startLinearAdMode invocation ' + '(State via ' + this.constructor.name + ')');
  };

  State.prototype.endLinearAdMode = function endLinearAdMode() {
    __WEBPACK_IMPORTED_MODULE_0_video_js___default.a.log.warn('Unexpected endLinearAdMode invocation ' + '(State via ' + this.constructor.name + ')');
  };

  State.prototype.skipLinearAdMode = function skipLinearAdMode() {
    __WEBPACK_IMPORTED_MODULE_0_video_js___default.a.log.warn('Unexpected skipLinearAdMode invocation ' + '(State via ' + this.constructor.name + ')');
  };
...
var Preroll = function (_AdState) {
  ...
  Preroll.prototype.onAdsError = function onAdsError(player) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_video_js___default.a.log('adserror (Preroll)');
...
var Postroll = function (_AdState) {
  ...
  Postroll.prototype.onEnded = function onEnded() {
    if (this.isContentResuming()) {
      ...
      __WEBPACK_IMPORTED_MODULE_0_video_js___default.a.log.warn('Unexpected ended event during postroll');
    }
  };
...
var VIDEO_EVENTS = __WEBPACK_IMPORTED_MODULE_0_video_js___default.a.getTech('Html5').Events;
...
var contribAdsPlugin = function contribAdsPlugin(options) {
  ...
  var settings = __WEBPACK_IMPORTED_MODULE_0_video_js___default.a.mergeOptions(defaults, options);
  ...
  var shouldDisableTracks = function shouldDisableTracks() {
    ...
    return !player.ads.shouldPlayContentBehindAd(player) && player.ads.inAdBreak() && player.tech_.featuresNativeTextTracks && __WEBPACK_IMPORTED_MODULE_0_video_js___default.a.browser.IS_IOS &&
...
/* unused harmony default export */ var _unused_webpack_default_export = (contribAdsPlugin);
